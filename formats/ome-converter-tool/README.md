...
```bash
docker run -e POLUS_IMG_EXT=".ome.zarr" --e  NUM_THREADS=4 -v /Users/username/:/Users/username/ polusai/ome-converter-tool:0.3.4-dev2 --inpDir=/Users/path/to/Images/ --filePattern=".*.tif" --outDir=/Users/path/to/outputs
