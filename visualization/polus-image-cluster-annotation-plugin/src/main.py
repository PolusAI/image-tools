...
def main():
    ...
    csvdir = args.csvdir
    logger.info(f"csvdir = {csvdir}")

    # Get the border width
    borderwidth = args.borderwidth
    logger.info(f"borderwidth = {borderwidth}")
    ...
    for inpfile in inputcsv:
        ...
        for index, row in cluster_data.iterrows():
            ...
            with BioReader(imgpath / filename) as br, BioWriter(
                outpath / filename, metadata=br.metadata,
            ) as bw:
