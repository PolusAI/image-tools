...
import typer
from polus.plugins.features.region_segmentation_eval.evaluate import POLUS_TAB_EXT
from polus.plugins.features.region_segmentation_eval import evaluate as evaluate
...
logger = logging.getLogger("polus.plugins.features.region_segmentation_eval")
