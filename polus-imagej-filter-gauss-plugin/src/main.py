...
if __name__=="__main__":
    ...
    parser = argparse.ArgumentParser(prog='main', description='GaussRAISingleSigma, DefaultGaussRAI')
    ...
    parser.add_argument('--sigma', dest='sigma', type=str,
                        help='sigma', required=False)
    parser.add_argument('--sigmas', dest='sigmas', type=str,
                        help='sigmas', required=False)
