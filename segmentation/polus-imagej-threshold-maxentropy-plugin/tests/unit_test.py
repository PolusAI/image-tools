...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold maxEntropy"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$MaxEntropy": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$MaxEntropy": "IterableInterval"}
