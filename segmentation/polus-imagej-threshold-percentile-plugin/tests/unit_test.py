...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold percentile"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$Percentile": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$Percentile": "IterableInterval"}
