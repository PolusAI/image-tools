...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold renyiEntropy"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$RenyiEntropy": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$RenyiEntropy": "IterableInterval"}
