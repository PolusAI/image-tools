...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold triangle"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$Triangle": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$Triangle": "IterableInterval"}
