...
from polus.images.segmentation.imagej_threshold_triangle.__main__ import app
from polus.images.segmentation.imagej_threshold_triangle.__main__ import main
