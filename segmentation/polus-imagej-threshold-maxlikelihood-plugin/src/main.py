...
def main(
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "ApplyThresholdMethod$MaxLikelihood":
                out = ij.op().threshold().maxLikelihood(in1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main",
        description="Implements a maximum likelihood threshold method by Dempster, Laird, Rubin and Glasbey.",
    )
