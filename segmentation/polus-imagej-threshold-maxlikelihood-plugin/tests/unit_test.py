...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold maxLikelihood"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$MaxLikelihood": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$MaxLikelihood": "IterableInterval"}
