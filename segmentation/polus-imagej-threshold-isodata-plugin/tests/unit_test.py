...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold isoData"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$IsoData": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$IsoData": "IterableInterval"}
