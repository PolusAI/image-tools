...
def main(
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "ApplyThresholdMethod$IsoData":
                out = ij.op().threshold().isoData(in1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main",
        description="Iterative procedure based on the isodata algorithm of:  Picture Thresholding Using an Iterative Selection Method. (1978). IEEE Transactions on Systems, Man, and Cybernetics, 8(8), 630–632. doi:10.1109/tsmc.1978.4310039",
    )
