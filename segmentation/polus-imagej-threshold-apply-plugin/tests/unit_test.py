...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold apply"
        self.logger.info(
        ...
        _threshold_wipp_types = {"ApplyManualThreshold": "number"}
        _threshold_imagej_types = {"ApplyManualThreshold": "RealType"}
        if _threshold_wipp_types.get(op, None) != "collection":
            method_call_types.update(
                {
                    method: dtype
                    for method, dtype in _threshold_imagej_types.items()
                    if dtype in supported_data_types
                }
            )
