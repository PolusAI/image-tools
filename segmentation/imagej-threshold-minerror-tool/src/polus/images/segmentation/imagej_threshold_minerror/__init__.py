"""Provides the ImageJ Threshold minerror tool."""
...
logger = logging.getLogger("polus.images.segmentation.imagej_threshold_minerror")
logger.setLevel(POLUS_LOG)


def threshold_minerror(
        ...
        with bfio.BioWriter(out_path, metadata=br.metadata) as bw:
            for y_min in range(0, br.Y, TILE_SIZE):
                ...
                for x_min in range(0, br.X, TILE_SIZE):
                    ...
                    img = ij.op().threshold().minError(img)
