"""Provides the ImageJ Threshold shanbhag tool."""
...
logger = logging.getLogger("polus.images.segmentation.imagej_threshold_shanbhag")
logger.setLevel(POLUS_LOG)


def threshold_shanbhag(
        ...
        with bfio.BioWriter(out_path, metadata=br.metadata) as bw:
            for y_min in range(0, br.Y, TILE_SIZE):
                ...
                for x_min in range(0, br.X, TILE_SIZE):
                    ...
                    img = ij.op().threshold().shanbhag(img)
