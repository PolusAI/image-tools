...
def main(
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "ApplyThresholdMethod$Moments":
                out = ij.op().threshold().moments(in1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main",
        description="Tsai’s method attempts to preserve the moments of the original image in the thresholded result.",
    )
