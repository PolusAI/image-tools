...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold moments"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$Moments": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$Moments": "IterableInterval"}
