...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold minError"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$MinError": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$MinError": "IterableInterval"}
