...
def main(
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "ApplyThresholdMethod$MinError":
                out = ij.op().threshold().minError(in1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main",
        description="An iterative implementation of Kittler and Illingworth’s Minimum Error thresholding.",
    )
