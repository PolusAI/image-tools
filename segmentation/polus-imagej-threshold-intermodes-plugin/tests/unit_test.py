...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold intermodes"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$Intermodes": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$Intermodes": "IterableInterval"}
