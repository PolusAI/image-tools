...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold minimum"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$Minimum": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$Minimum": "IterableInterval"}
