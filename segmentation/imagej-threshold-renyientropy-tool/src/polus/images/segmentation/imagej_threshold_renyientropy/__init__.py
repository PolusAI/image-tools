"""Provides the ImageJ Threshold renyientropy tool."""
...
logger = logging.getLogger("polus.images.segmentation.imagej_threshold_renyientropy")
logger.setLevel(POLUS_LOG)


def threshold_renyientropy(
        ...
        with bfio.BioWriter(out_path, metadata=br.metadata) as bw:
            for y_min in range(0, br.Y, TILE_SIZE):
                ...
                for x_min in range(0, br.X, TILE_SIZE):
                    ...
                    img = ij.op().threshold().renyiEntropy(img)
