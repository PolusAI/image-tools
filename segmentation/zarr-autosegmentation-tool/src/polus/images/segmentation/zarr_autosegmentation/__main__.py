...
def main(  # noqa: PLR0913 D417 C901 PLR0912 PLR0915
    ...
    """Takes a pyramidal dataset of ome zarr data and flattens it into
    high resolution slices, usually along the z axis.
    ...
    Args:
        inpDir: Path or url to an ome zarr database
