...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ threshold shanbhag"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"ApplyThresholdMethod$Shanbhag": "collection"}
        _in1_imagej_types = {"ApplyThresholdMethod$Shanbhag": "IterableInterval"}
