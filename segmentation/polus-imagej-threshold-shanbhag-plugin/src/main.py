...
def main(_opName: str,
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "ApplyThresholdMethod$Shanbhag":
                out = ij.op().threshold().shanbhag(in1)
...
if __name__=="__main__":
    ...
    parser = argparse.ArgumentParser(prog='main', description='Implements Shanbhag's extension of Kapur's Renyi Entropy method.')
    ...
    parser.add_argument('--inpDir', dest='in1', type=str,
                        help='Collection to be processed by this plugin', required=False)
