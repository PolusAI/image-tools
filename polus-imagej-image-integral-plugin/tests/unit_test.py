...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = 'ImageJ image integral'
        ...
        _opName = op
        _in1_wipp_types = {'DefaultIntegralImg': 'collection', 'WrappedIntegralImg': 'collection'}
        _in1_imagej_types =  {'DefaultIntegralImg': 'RandomAccessibleInterval', 'WrappedIntegralImg': 'RandomAccessibleInterval'}
