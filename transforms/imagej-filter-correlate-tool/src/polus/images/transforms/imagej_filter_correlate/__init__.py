"""Provides the ImageJ filter correlate tool."""
...
logger = logging.getLogger("polus.images.transforms.imagej_filter_correlate")
logger.setLevel(POLUS_LOG)


def filter_correlate(
    ...
    # Rotate the filter image by 180 degrees
    filter_img = numpy.rot90(filter_img, 2)
