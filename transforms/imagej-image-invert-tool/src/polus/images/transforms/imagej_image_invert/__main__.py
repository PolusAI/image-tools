...
import tqdm
import typer
from polus.images.transforms.imagej_image_invert import POLUS_LOG
from polus.images.transforms.imagej_image_invert import image_invert
...
def main(
    ...
    for inp_path in tqdm.tqdm(files):
        image_invert(inp_path, out_dir, ij)
