...
def main(stitch_dir: Path,
    ...
    for vector in vectors:
        ...
        for variable in vps[vector.name].variables:
            ...
            elif variable in singulars.keys() and vps[vector.name].uniques[variable] != singulars[variable]:
    ...
    for vector in vectors:
        ...
        matching = {k.upper():sp.uniques[k][0] for k,v in singulars.items() if v is None}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--stitchDir',
                        dest='stitch_dir',
                        type=str,
                        help='Stitching vector to recycle',
                        required=True)
    parser.add_argument('--collectionDir',
                        dest='collection_dir',
                        type=str,
