...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ transform flatIterableView"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"DefaultFlatIterableView": "collection"}
        _in1_imagej_types = {"DefaultFlatIterableView": "RandomAccessibleInterval"}
