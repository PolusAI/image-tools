...
from polus.images.transforms.imagej_filter_tubeness.__main__ import app
from polus.images.transforms.imagej_filter_tubeness.__main__ import main
...
def test_imagej_tool(
    ...
    main(inp_dir, ".*", 1.25, "11.25,11.25", out_dir)
