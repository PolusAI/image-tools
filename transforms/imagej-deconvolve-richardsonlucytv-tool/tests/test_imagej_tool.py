...
from polus.images.transforms.imagej_deconvolve_richardsonlucytv.__main__ import app
from polus.images.transforms.imagej_deconvolve_richardsonlucytv.__main__ import main
...
def test_imagej_tool(
    ...
    main(inp_dir, ".*", psf_path, max_iterations, 0.01, out_dir)
