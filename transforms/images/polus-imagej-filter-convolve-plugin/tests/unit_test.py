...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = 'ImageJ filter convolve'
        ...
        _opName = op
        _in1_wipp_types = {'ConvolveNaiveF': 'collection', 'PadAndConvolveFFTF': 'collection', 'PadAndConvolveFFT': 'collection', 'ConvolveFFTC': 'collection'}
        _in1_imagej_types =  {'ConvolveNaiveF': 'RandomAccessibleInterval', 'PadAndConvolveFFTF': 'RandomAccessibleInterval', 'PadAndConvolveFFT': 'RandomAccessibleInterval', 'ConvolveFFTC': 'RandomAccessibleInterval'}
        ...
        _in2_wipp_types = {'ConvolveNaiveF': 'collection', 'PadAndConvolveFFTF': 'collection', 'PadAndConvolveFFT': 'collection', 'ConvolveFFTC': 'collection'}
        _in2_imagej_types =  {'ConvolveNaiveF': 'RandomAccessibleInterval', 'PadAndConvolveFFTF': 'RandomAccessibleInterval', 'PadAndConvolveFFT': 'RandomAccessibleInterval', 'ConvolveFFTC': 'RandomAccessibleInterval'}
        if _in2_wipp_types.get(op, None) != 'collection':
            method_call_types.update({method:dtype for method,dtype in _in2_imagej_types.items() \
                if dtype in supported_data_types})
