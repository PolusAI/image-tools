...
def main(_opName: str,
    ...
    # Validate in1
    in1_types = { 
        "ConvolveNaiveF": "RandomAccessibleInterval",
        "PadAndConvolveFFTF": "RandomAccessibleInterval",
        "PadAndConvolveFFT": "RandomAccessibleInterval",
        "ConvolveFFTC": "RandomAccessibleInterval",
    }
    ...
    """ Run the plugin """
    try:
        for ind, (in1_path,in2_path,) in enumerate(zip(*args)):
            if in1_path != None:
            ...
            if in2_path != None:
                ...
                # Convert to appropriate numpy array
                in2 = ij_converter.to_java(ij, np.squeeze(in2_br[:,:,0:1,0,0]),in2_type)
...
if __name__=="__main__":
    ...
    parser = argparse.ArgumentParser(prog='main', description='ConvolveNaiveF, PadAndConvolveFFTF, PadAndConvolveFFT, ConvolveFFTC')
    
    # Add command-line argument for each of the input arguments
    parser.add_argument('--opName', dest='opName', type=str,
                        help='Op overlaoding method to peform', required=True)
    parser.add_argument('--inpDir', dest='in1', type=str,
                        help='Input image collection to be processed by this plugin', required=True)
    parser.add_argument('--weights', dest='in2', type=str,
                        help='Array of weights with same number of dimensions as input', required=True)
    ...
    _in2 = Path(args.in2)
    logger.info('weights = {}'.format(_in2))
