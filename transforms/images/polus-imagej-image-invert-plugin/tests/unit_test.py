...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ image invert"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {"InvertIIInteger": "collection", "InvertII": "collection"}
        _in1_imagej_types = {
            "InvertIIInteger": "IterableInterval",
            "InvertII": "IterableInterval",
        }
