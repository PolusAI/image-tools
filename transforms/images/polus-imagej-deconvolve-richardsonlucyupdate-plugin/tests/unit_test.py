...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ deconvolve richardsonLucyUpdate"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {
            "RichardsonLucyTVUpdate": "collection",
            "RichardsonLucyUpdate": "collection",
        }
        _in1_imagej_types = {
        ...
        _regularizationFactor_wipp_types = {"RichardsonLucyTVUpdate": "number"}
        _regularizationFactor_imagej_types = {"RichardsonLucyTVUpdate": "float"}
