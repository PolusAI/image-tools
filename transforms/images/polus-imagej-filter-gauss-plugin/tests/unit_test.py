...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        _opName = op
        _in1_wipp_types = {
            "GaussRAISingleSigma": "collection",
            "DefaultGaussRAI": "collection",
        }
        _in1_imagej_types = {
        ...
        if _sigmas_wipp_types.get(op, None) != "collection":
            method_call_types.update(
                {
                    method: dtype
                    for method, dtype in _sigmas_imagej_types.items()
                    if dtype in supported_data_types
                }
            )
        ...
        _sigmas = self.generate_data(
            "sigmas", _sigmas_wipp_types.get(op, None), method_call_types.get(op, None)
        )
