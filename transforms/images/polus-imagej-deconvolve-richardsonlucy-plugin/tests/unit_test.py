...
class UnitTest(unittest.TestCase):
    ...
    def test_plugin(self):
        ...
        projectName = "ImageJ deconvolve richardsonLucy"
        self.logger.info(
        ...
        _opName = op
        _in1_wipp_types = {
            "PadAndRichardsonLucy": "collection",
            "RichardsonLucyC": "collection",
        }
        _in1_imagej_types = {
        ...
        _maxIterations_wipp_types = {
            "PadAndRichardsonLucy": "number",
            "RichardsonLucyC": "number",
        }
        _maxIterations_imagej_types = {
