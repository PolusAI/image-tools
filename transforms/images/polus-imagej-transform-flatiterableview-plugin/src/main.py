...
def main(
    ...
    """ Set up the output """
    out_types = {
        "DefaultFlatIterableView": "IterableInterval",
    }
    ...
    try:
        for ind, (in1_path,) in enumerate(zip(*args)):
            ...
            if _opName == "DefaultFlatIterableView":
                out = ij.op().transform().flatIterableView(in1)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="main", description="Transforms input image into a flatIterableView object"
    )
