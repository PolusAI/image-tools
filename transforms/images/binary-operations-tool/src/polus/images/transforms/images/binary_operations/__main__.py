...
from polus.images.transforms.images.binary_operations import Operation
from polus.images.transforms.images.binary_operations import StructuringShape
from polus.images.transforms.images.binary_operations import __version__
from polus.images.transforms.images.binary_operations import batch_binary_ops
...
logger = logging.getLogger("polus.images.transforms.images.binary_operations")
logger.setLevel(os.environ.get("POLUS_LOG", logging.INFO))


@app.command()
def _main(  # noqa: PLR0913 -- CLI must keep 9 options for plugin/CWL compatibility
    ...
    if preview:
        preview_path = pathlib.Path(out_dir) / "preview.json"
