...
import tqdm
import typer
from polus.images.transforms.imagej_filter_sobel import POLUS_LOG
from polus.images.transforms.imagej_filter_sobel import filter_sobel
...
def main(
    ...
    for inp_path in tqdm.tqdm(files):
        filter_sobel(inp_path, out_dir, ij)
